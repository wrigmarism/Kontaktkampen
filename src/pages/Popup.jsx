    ...
    return (
      <div className='popup'>
        <div className='popup_inner'>
          <h5><b>Behandling av data</b></h5>
          <p>Vi behöver spara och behandla personuppgifter om dig, så som namn och e-postadress. Syftet med en
sådan behandling är för att kunna bedriva den avsedda tävlingen, och när den är avslutad kontakta utsedda vinnare</p>

<p>
Vi har fått dina uppgifter från det formulär du registrerat dig med. Vi tillämpar vid var tid gällande
...
<p>Personuppgiftsansvarig är <i>Uppsalaekonomerna, Kyrkogårdsgatan 2B, 753 12 Uppsala</i>. Du har rätt att kontakta 
